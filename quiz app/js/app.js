...
var questions = [
  ...
  new Question("Which part of the body is considered an illegal target zone?", ["Chest","Above the shoulder", "Hips"], "Above the shoulder"),

  new Question("How many timeouts does each team have per game?", ["One", "Two", "Three", "Zero"], "Three"),
]
